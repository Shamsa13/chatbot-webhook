...
function getFileIcon(filename) {
    ...
    // Assign a clean, muted accent color based on the file type
    let colorClass = 'svg-txt';
    if (ext === 'pdf') colorClass = 'svg-pdf';
    if (ext === 'docx' || ext === 'doc') colorClass = 'svg-doc';
    
    // Return a crisp, modern line-art file icon
    return `<svg class="modern-file-icon ${colorClass}" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
